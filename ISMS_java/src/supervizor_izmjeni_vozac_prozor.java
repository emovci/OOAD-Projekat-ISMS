...
public class supervizor_izmjeni_vozac_prozor {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					supervizor_izmjeni_vozac_prozor window = new supervizor_izmjeni_vozac_prozor();
	 ...
	 */
	public supervizor_izmjeni_vozac_prozor() {
		initialize();
	}
