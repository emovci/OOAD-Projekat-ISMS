...
public class supervizor_zaposli_vozac_prozor {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					supervizor_zaposli_vozac_prozor window = new supervizor_zaposli_vozac_prozor();
	 ...
	 */
	public supervizor_zaposli_vozac_prozor() {
		initialize();
	}
